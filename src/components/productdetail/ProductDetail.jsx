            ...
            <div className='productlisting-page'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-md-12'>
                            <ul className='breadcrumbs'>
                                ...
                                <li><a href='#' className='active'>Aktuálne</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className='row'>
                        ...
                        <div className='col-md-6'>
                            <div className='product-detail-content'>
                                ...
                                <div className='delivery-details-add'>
                                    ...
                                    <span>Objednávky v rámci <b> Košíc a Prešova</b></span>
                                    <span>vám doručíme <b> ešte dnes</b></span>
                                </div>
                                ...
                                <div className='product-price desktop-hide'>
                                    <h2>37,99€</h2>
                                ...
                                <div className='product-size-range-detail'>
                                    <div className='heading-holds'>
                                        <h5>Darčeky k nákupu</h5>
                                        <span class="icon-gift"></span>
                                    </div>
                                    <div className='prodict-detail-resp-check'>
                                        <div className='payment-check'>
                                            <input class="input-filter" type="checkbox" name="cat_filter[]" id="payment-check-b1" value="" />
                                            <label class="span1-filter" for="payment-check-b1">Ochranné sklo</label>
                                        </div>
                                        <span className='item_brand'>Darček k nákupu</span>
                                    </div>
                                    <div className='prodict-detail-resp-check'>
                                        <div className='payment-check'>
                                            <input class="input-filter" type="checkbox" name="cat_filter[]" id="payment-check-b1" value="" />
                                            <label class="span1-filter" for="payment-check-b1">Transparentný silikónový obal</label>
                                        </div>
                                        <span>9,95 €</span>
                                    </div>
                                    <div className='prodict-detail-resp-check'>
                                        <div className='payment-check'>
                                            <input class="input-filter" type="checkbox" name="cat_filter[]" id="payment-check-b1" value="" />
                                            <label class="span1-filter" for="payment-check-b1">Celoplošné zaoblené ochranné sklo</label>
                                        </div>
                                        <span>19,99 €</span>
                                    </div>
                                    <div className='prodict-detail-resp-check'>
                                        <div className='payment-check'>
                                            <input class="input-filter" type="checkbox" name="cat_filter[]" id="payment-check-b1" value="" />
                                            <label class="span1-filter" for="payment-check-b1">Ochranné sklo na fotoaparát</label>
                                        </div>
                                        <span>6,54 €</span>
                                    </div>
                                </div>
                                <div className='product-detail-price-resp-hold'>
                                    <div className='product-price responsive-only'>
                                        <h2>37,99€</h2>
                                        <p>cena je uvedená s DPH</p>
                                    </div>
                                    <div className='review-recently-show'>
                                        <div className='box-right  responsive-only'>
                                ...
                                <div className='review-recently-show'>
                                    ...
                                    <div className='box-right desktop-hide'>
                                        <div className='starts'>
                                            <fieldset className='rate'>
                                                <input type='radio' id='rating10' name='rating' value='10' /><label for='rating10' title='5 stars'></label>
                                                <input type='radio' id='rating9' name='rating' value='9' /><label class='half' for='rating9' title='4 1/2 stars'></label>
                                ...
                                <div className='related-products'>
                                    ...
                                    <div className='row item-box-pd-row owl-carousel owl-carousel-4 custom-colum-hide'>
                    ...
                    <div className='related-products-row'>
                        <div className='row featr-pd-bottom-hold heading-resp-pd'>
                            <div className='col-md-12'>
                                <div className='productd-main-heading'>
